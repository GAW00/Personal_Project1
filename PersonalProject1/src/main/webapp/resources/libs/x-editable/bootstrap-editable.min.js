...
function(a) {
    ...
    a.extend(a.fn.editableform.Constructor.prototype, {
        ...
        initInput: function() {
            ...
            ~a.inArray(this.input.type, e) && c && (this.input.options.inputclass = d,
    ...
    a.extend(b.prototype, {
        ...
        sorter: function(a) {
            for (var b, c, d = [], e = [], f = []; b = a.shift(); )
                c = b.text,
                c.toLowerCase().indexOf(this.query.toLowerCase()) ? ~c.indexOf(this.query) ? e.push(b) : f.push(b) : d.push(b);
            return d.concat(e, f)
        },
        ...
        updater: function(a) {
            return this.$element.data("value", a.value),
            a.text
        },
        typeaheadRender: function(b) {
            var c = this;
            return b = a(b).map(function(b, d) {
                return b = a(c.options.item).data("item", d),
        ...
        typeaheadSelect: function() {
            ...
            return (this.options.autoSelect || a) && this.$element.val(this.updater(a)).change(),
            this.hide()
        },
